...
\title{Understanding the metabolic basis of variability in \textit{D. melanogaster} flight and respiration} 
\date{}
...
The reactions which interconvert metabolites are fairly well understood in most model organisms; however the breadth of metabolic variability and its functional consequences for other complex phenotypes are not.  The well defined pathways dealing with catabolism of stored nutrients in order to produce flight power in \textit{D. melanogaster} provides a system whereby variation in metabolic phenotypes can be associated with the resulting production of energy and its biomechanical utilization.  The traits of interest for this study were the catalytic activity of 19 enzymes, resting respiration rate and free-flight profiles.  Analyzing metabolic variation across 92 inbred lines, derived from five populations, we find extensive heterogeneity in these traits, which can partially be explained based on metabolic phenotypes.  Using an integrated analysis of gas-exchange and metabolic data, we are able to recast these phenotypes as resting fluxes and observe extensive inter-population variation.  

\section*{Introduction}

$\textit{Drosophila}$ flight, respiration and metabolism have been studied from physiological, molecular and mechanical perspectives over the last century, but the systems-wide relationships between variability of these traits remain poorly understood.  Studies to fill this void have largely focused on relating variability in flight metrics as an indicator of energy production, with metabolic phenotypes that are necessary for the production of this energy \cite{LaurieAhlberg:1985vx, Suarez:1996tg, Montooth:2003wj}.  While genetic variants contributing to variability in these traits have been found, dependence between traits responsible for resting energy production and traits requiring extreme levels of energy production has been more difficult to demonstrate.  
...
Measuring the rate of gas-exchange at rest is one indirect way of measuring metabolic flux. Oxygen is consumed when it is reduced by cytochrome c oxidase to translocate protons during the electron transport chain.  Because this proton motive force is then depleted to regenerate ATP, there is an association between oxygen consumption and ATP turnover, although it cannot be interpreted as a direct proxy.  The production of ATP during substrate-level phosphorylation and unaccounted variability in the utilization of anaerobic metabolism across our samples weakens the association between ATP and O$_{2}$ consumption.  Still the association between oxygen consumption and ATP production can be supported by the observation that during hovering flight, mechanical power output is highly correlated with the rate of oxygen consumption \cite{LaurieAhlberg:1985vx}.
...
Metabolism ultimately produces energy for flight in the form of ATP, resulting in gas-exchange in the process.  While the details of this process have been extensively described, the source of variability in flight is less apparent.  Because the energy for flight is generated through collective flux through glycolysis and the TCA cycle, studies have attempted to describe the extent to which variability in energy production and flight are dependent upon the activity levels of specific enzymes.  It has been shown that in order to reach the high glycolytic flux needed to support flight, \textit{in vivo} activities of some glycolytic enzymes approach the ideal maximum \cite{Suarez:1996tg}, while other enzymes require excess activity to drive a forward reaction \cite{Suarez:2000ez}.  Additionally, moderate to severe reductions in the activities of most enzymes are necessary to significantly perturb the frequency of wing beats \cite{Eanes:2006jw}.  This is in agreement with the predictions of metabolic control theory, whereby the flux through a pathway is not directly dependent upon a single enzyme, but rather spread among enzymes in a pathway in a manner reflecting the abundance of metabolites and activity of enzymes \cite{Kacser:1995wk}.  Natural variability in many enzymes has previously been demonstrated \cite{LaurieAhlberg:1980uz, LaurieAhlberg:1982wk}, but flux should be buffered to much of this variation in the same way as for introduced mutations.  Still, natural variants of glycerol-3-phosphate dehydrogenase and phosphoglucose isomerase have been found which affect flight phenotypes in \textit{Drosophila} and \textit{Colias} butterflies respectively \cite{Watt:1983vy, Clark:1983bg, Barnes:1986vo}. 
...
The presence of considerable variation in flight performance across segregants, \textcolor{red}{even greater in this set of lines than has previously been shown} underscores that there is sufficient variation for selection to act upon.  While the relationship between flight phenotypes and fitness is not simple, it is likely that higher takeoff angles, velocity and acceleration allow for improved fitness.  Higher performance in all of these metrics in turn require greater energy consumption and higher metabolic output.

To determine whether energetic requirements of flight are paralleled in metabolic variation, we sought to determine if these Drosophila lines differed in either the metabolic capacity of enzymes or patterns of pathway utilization.  While tracking the energy output during flight would be most appropriate for making this comparison, due to experimental intractability, we thought to assess whether this relationship could be found using a model of metabolism created from resting flies.  In producing this sort of model, we thought to integrate both previously measured enzyme activities \cite{Greenberg:2011jf} as well as direct gas-exchange fluxes.  These gas-exchange rates, of CO$_{2}$ production and O$_{2}$ consumption are an important metabolic constraints as they are indicative of the overall flux through the electron transport chain as well as the net levels of biomolecule production or breakdown relative to energy generation.   
...
Flight performance is central to the fitness of \textit{D. melanogaster}, and while performance can be modulated by strong enzyme mutations, and through directed evolution \textcolor{red}{cite}, it is unclear how flight is constrained in the wild.  To investigate the sources of natural variation in flight performance, we tracked takeoff flight trajectories using a set of 92 inbred lines previously used to determine the extent of variability in enzyme V$_{max}$ \cite{Greenberg:2011jf} .
...
Through quantifying rates of CO$_{2}$ and O$_2$ gas-exchange, we are able to show that these two traits are non-substitutable, but rather show substantial departures that are telling of gross metabolic differences across genetic backgrounds.  These metabolic departures are chiefly associates with how much ATP is made at rest and how much energy is stored as lipids.  Large differences between populations are observed in these traits, notably distinguishing the Beijing population, which will be a subject of future investigation.     
